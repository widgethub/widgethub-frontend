            ...
            <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form className="flex flex-col pt-3 md:pt-8" onSubmit={handleSubmit}>
                    <div className="flex flex-col pt-4">
                        <input type="text" onChange={e => setUserName(e.target.value)} placeholder="Username" className={`${usernamered === true? 'border-red-500 bg-red-50 placeholder-red-400': ''} shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline`}/>
                    </div>
  
                    <div className="flex flex-col pt-4">
                        <input type="password" onChange={e => setPassword(e.target.value)} placeholder="Password" className={`${passwdred === true? 'border-red-500 bg-red-50 placeholder-red-400': ''} shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline`}/>
                    </div>
